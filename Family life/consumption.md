...
## 手机号更换计划
我决定保留中国工商银行、中国银行、上海银行的储蓄卡。信用卡多多益善。

所以我现在应该注销：邮政银行储蓄卡、招商银行储蓄卡、河南农村信用社储蓄卡、民生银行储蓄卡、中信银行储蓄卡、交通银行储蓄卡、建设银行储蓄卡。

先要打电话，确认一下，怎么注销。满足条件后，如果碰巧某天出门办事可以去银行一下。
### Samsung
...
一定要算清楚，到工作地点、大型商超、小型生活超市、快递点、加油站等地有多远，各种快递、各种买菜软件能否上门。能外卖就外卖，没办法，中国人力成本确实便宜，我身在其中，也不得不、自然而然去互相剥削压制。
